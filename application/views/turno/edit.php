<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('turno/edit/'.$turno['id_turno']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_especialidad" class="form-control">
								...
								{
									$selected = ($especialidade['id_especialidad'] == $turno['id_especialidad']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_cliente" class="form-control">
								...
								{
									$selected = ($cliente['id_cliente'] == $turno['id_cliente']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="fecha" value="<?php echo ($this->input->post('fecha') ? $this->input->post('fecha') : $turno['fecha']); ?>" class="has-datetimepicker form-control" id="fecha" />
